...
An answer to a pattern contains only those variables.
...
Consider another case of composition gone wrong:
[,typeql]
----
match
$p1 isa person; $p2 isa person;
...
1. Local to a branch of a disjunction.
2. Local to a negation.
